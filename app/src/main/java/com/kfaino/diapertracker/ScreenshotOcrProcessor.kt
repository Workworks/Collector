    ...
    fun processScreenshot(
        ...
        executor.execute {
            ...
            try {
                ...
                val savedFilename = ImageVaultHelper.saveUriToVault(context, imageUri, "screenshot")
                val fullSandboxPath = if (savedFilename != null) {
                    File(ImageVaultHelper.getVaultDir(context), savedFilename).absolutePath
                } else ""
                ...
                recognizer.process(inputImage)
                    .addOnSuccessListener { visionText ->
                        ...
                        val record = ClippingRecord(
                            ...
                            fullMarkdown = "",
                            ocrRawText = rawText,
                            localImagePaths = listOf(fullSandboxPath),
