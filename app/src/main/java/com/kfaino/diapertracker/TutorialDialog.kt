...
object TutorialDialog {
    ...
    private val TUTORIAL_LIST = listOf(
        ...
        TutorialItem(
            category = "spatial",
            icon = "🎒",
            title = "场景装备套装与旅行出差装箱核对舱",
            summary = "商务出差、露营、海岛亲子出行套装一键生成，支持出发装箱与返程离店双向清点及 1080P 清单海报导出。",
            steps = listOf(
                "在首页快捷工具栏点击【🎒 装备套装】，查看 6 大实用出行预设或点击【➕ 新建】自定义装备包；",
                "点击套装卡片勾选关联库内具体物品（如笔记本、洗漱分装瓶、降噪耳机等）；",
                "出行前点击【📦 核对清单】，自由切换【🛫 出发装箱】与【🏨 返程清点】模式；",
                "逐项勾选打卡装箱进度，点击【📜 导出清单海报】一键生成 1080P 高清装备清单图发给同行亲友。"
            ),
            tip = "出差旅游或户外露营前打包核对，返程离店前逐一清点，彻底告别落带丢件的烦恼！",
            tourKey = "kit_manager"
        ),
