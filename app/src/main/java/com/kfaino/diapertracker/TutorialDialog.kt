...
object TutorialDialog {
    ...
    private val TUTORIAL_LIST = listOf(
        ...
        TutorialItem(
            ...
            icon = "🪪",
            title = "家庭多成员证照安全夹",
            summary = "全家身份证、护照、户口本、结婚证、房产证集中分类收纳，证号一键复制与防盗流水印导出。",
            steps = listOf(
                "在首页顶栏工具箱点击【🪪 证照安全夹】，按家庭成员（本人/伴侣/孩子/父母）快速切换；",
                "点击【➕ 登记证照】，选择证件类型、填写证件号、签发机关与有效期截止日；",
                "证件号码默认安全脱敏展示，点击证号一秒完整复制到剪贴板，办事填表免手动输入；",
                "身份证/护照到期前 6 个月自动预警提醒换证，安全省心。"
            ),
            tip = "全家重要证照电子化加密收纳，填表办事不用满屋找原件，到期换证永不遗忘！",
