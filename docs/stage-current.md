...
更新：2026-09-18。**正式版为 v4.3.10；Stage 463–468 已发布，Stage 469 的 14 天观察已结束，结论为“调整验证方式”。** 发布附件、签名覆盖升级、下载源 Range 和回下载哈希均已验证；真实使用样本为 0 天，不能据此宣称体验达标或要求版本回退。见 [v4.3.10 发布报告](releases/v4.3.10-report.md)与 [Stage 469](stages/stage-469-low-friction-observation.md)。
